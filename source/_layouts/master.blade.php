...
<html lang="en">
    ...
    <body class="flex flex-col justify-between min-h-screen bg-gray-100 text-gray-800 leading-normal font-sans">
        ...
        <footer class="bg-white text-center text-sm mt-12 py-4" role="contentinfo">
            <ul class="flex flex-col md:flex-row justify-center list-none">
                <li class="md:mr-2">
                    &copy; <a href="#">Rajkumar Sakthi</a> {{ date('Y') }}. All rights reserved
                </li>
            </ul>
        </footer>
    ...
    <div class="px-1 mx-4">
        <a href="https://www.github.com/rajkumarsakthivel" target="_blank" rel="noopener">
    ...
    <div class="px-1 mx-4">
        <a href="https://www.linkedin.com/in/rajkumar-sakthivel" target="_blank" rel="noopener">
            ...
            <ul class="flex flex-col md:flex-row justify-center list-none">
                <li class="md:mr-2">
                    &copy; <a href="#">Rajkumar Sakthi</a> {{ date('Y') }}
                </li>
            </ul>
        </footer-->
